...
local state=(luci.sys.call("pidof deluge-web > /dev/null") == 0)
if state then
	...
	p.description = translate("deluge默认WebUI端口：888  登录密码：deluge" .. "<br/><br/>".. state_msg)
end
...
p.default = "81"
p.rmempty = true
local state=(luci.sys.call("pidof rtorrent > /dev/null") == 0)
if state then
	...
	p.description = translate("rutorrent默认WebUI端口：81" .. "<br/><br/>".. state_msg .. "&nbsp;&nbsp;&nbsp;".. o)
else
	state_msg = "<b><font color=\"red\">" .. translate("rutorrent 没有运行") .. "</font></b>"
	p.description = translate("rutorrent默认WebUI端口：81" .. "<br/><br/>".. state_msg)
end
p:depends("rtorrent_install", 1)
...
local state=(luci.sys.call("pidof transmission-daemon > /dev/null") == 0)
if state then
	...
	p.description = translate("transmission默认WebUI端口：9091" .. "<br/><br/>".. state_msg .. "&nbsp;&nbsp;&nbsp;".. o)
else
	state_msg = "<b><font color=\"red\">" .. translate("transmission 没有运行") .. "</font></b>"
	p.description = translate("transmission默认WebUI端口：9091" .. "<br/><br/>".. state_msg)
end
