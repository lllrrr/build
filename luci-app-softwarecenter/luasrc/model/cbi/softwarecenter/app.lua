...
if state then
	...
	o=font_apply .. translate("打开AriNG管理") .." \" onclick=\"window.open('http://ariang.mayswind.net/latest')\"/>&nbsp;&nbsp;&nbsp;" .. font_apply .. translate("打开webui-aria2管理") .." \" onclick=\"window.open('http://webui-aria2.1ge.fun/')\"/>"
	state_msg = font_green .. translate("Aria2 运行中") .. font_off
	p.description = translate(("Aria2 RPC 监听端口为默认: 6800，密钥为默认: Passw0rd<br>添加了") .. [[<a href="https://github.com/P3TERX/aria2.conf"target="_blank">]] .. " P3TERX </a>的增强和扩展功能<br>" .. state_msg .. "<br>" .. o )
else
...
if state then
	...
	p.description = translate(("rTorrent默认WebUI端口: 1099。Rutorrent替换为") .. [[<a href="https://github.com/Novik/ruTorrent"target="_blank">]] .. " Novik </a>的稳定插件版<br>" .. state_msg .. "<br>" .. o )
else
