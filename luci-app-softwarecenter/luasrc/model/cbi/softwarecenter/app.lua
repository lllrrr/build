...
if state then
	...
	p.description = translate(("Aria2 添加了") .. [[<a href="https://github.com/P3TERX/aria2.conf"target="_blank">]] .. translate(" P3TERX ") .. [[</a>]] .. translate("的增强和扩展功能。RPC的默认密码为:Passw0rd") .. "<br>" .. state_msg .. "<br>" .. o )
else
