...
m = Map("speedlimit", translate("CowB Speed Limit"))
m.description = translate("CowB Speed Limit can limit user's speed via MAC or IP or IP range.").. button .. "<br/><br/>" .. translate("Running state").. " : "  .. state_msg .. "<br />"
