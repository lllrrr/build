...
month=s:option(Value,"month",translate("月 <font color=\"green\">(数值范围1～12)</font>"), translate("<font color=\"gray\">*表示每个月，*/n表示每n个月</br>n1-n5连续，n1,n3,n5不连续</font>"))
month.rmempty = false
month.default = '*'

day=s:option(Value,"day",translate("日 <font color=\"green\">(数值范围1～31)</font>"), translate("<font color=\"gray\">*表示每天，*/n表示每n天</br>n1-n5连续，n1,n3,n5不连续</font>"))
day.rmempty = false
day.default = '*'
